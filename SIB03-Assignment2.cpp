...
template<typename T> void Stack <T> :: infixtoprefix (char infix[15],char postfix[15],char revinfix[15],char prefix[15])
{
...
template<typename T> void Stack <T> :: evalpostfix (char postfix[15],char infix[15],float eval[15])
{
	int i=0;
	float result;
	float result1;
...
template<typename T> void Stack <T> :: evalprefix (char infix[15],char postfix[15],char revinfix[15],char prefix[15],float eval[15])
{
	int i=0;
	float result;
	float result1;
